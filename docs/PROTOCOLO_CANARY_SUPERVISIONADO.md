...
### 🔹 Onda 1: Canary Inicial (1 a 3 Casos Reais)
* **Objetivo:** Validar a integridade ponta a ponta da esteira de ingestão e geração de Laudo PDF.
* **Volume:** 3 empresas selecionadas.
* **Critério de Saída da Onda:** 100% de geração de laudos em < 3 minutos por caso, zero erros de schema e validação manual de Rafael.

### 🔹 Onda 2: Expansão Controlada (4 a 5 Casos Reais)
...
### 🔹 Onda 3: Piloto Consolidado (6 a 10 Casos Reais)
...
4. **Despacho de Rafael:** Na Mesa do Revisor (`/reviews`), Rafael seleciona:
