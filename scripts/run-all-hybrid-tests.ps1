...
$tests = @(
    ...
    @{ Name = 'WF-13 - GG Performance MVP'; Script = 'scripts/test-wf13-performance-mvp.ps1' },
    @{ Name = 'Telegram Conversacional Supervisionado'; Script = 'scripts/test-telegram-conversational.ps1' },
