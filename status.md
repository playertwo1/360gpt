...
**Data do status:** 1 de setembro de 2026, 07:22 (America/Sao_Paulo)
...
**Saúde do Projeto:** 🟡 **DOCKER EM G: OPERACIONAL; POSTGRESQL SAUDÁVEL; BUILD OCR E RECUPERAÇÃO DO N8N PENDENTES**
...
**Worker e agenda:** imagens de `document-worker`/MinerU em reconstrução após a migração do armazenamento; WF-11 permanece versionado, mas a ativação local deve ser confirmada quando o n8n voltar a ficar saudável.
...
**Próximo passo exato:** concluir o build único já iniciado, recuperar somente o n8n sem recriar volumes, validar PostgreSQL/worker/MinerU e executar um teste Telegram ponta a ponta; depois retomar o ensaio M5.10 de reutilização auditada.
