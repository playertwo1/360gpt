...
Last validation: 2026-09-01 — npm lint PASS; npm build PASS; document-worker PASS (container saudável, comunicação n8n→worker e smoke Docling); parecer Telegram corrigido sem truncamento prematuro
