...
Last completed: Versão hospedada 37 publicada com correção do destinatário Telegram; worker e agenda do WF-11 permanecem ativos
...
Blockers:
- O retorno útil ao Telegram depende do ensaio real com um novo arquivo após a publicação da versão 37.
